  ...
  <main class="mt-8 w-full">
    ...
    <section class="mt-6 grid grid-cols-[1.8fr_1fr] gap-8">
      ...
      <aside class="rounded-[2rem] border border-paper-600/50 bg-paper-200/90 p-8 shadow-soft">
        ...
        <div class="mt-8 grid grid-cols-2 gap-x-8 gap-y-10">
          <div v-for="item in featureList" :key="item.title" class="flex flex-col items-center text-center">
    ...
    <section class="mt-10">
      ...
      <div class="mt-5 grid grid-cols-3 gap-4">
        ...
        >
          <div class="grid h-14 w-14 shrink-0 place-content-center rounded-2xl bg-paper-900 text-xl text-paper-100">📻</div>
          <div class="min-w-0 flex-1">
            <button
              type="button"
            ...
            <p class="mt-1 truncate text-xl text-paper-700">{{ program.meta }}</p>
          </div>
        </article>
      </div>
    </section>
