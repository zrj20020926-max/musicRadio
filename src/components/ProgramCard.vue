...
<template>
  <article class="retro-card rounded-[1.5rem] p-4 transition-all duration-150 hover:-translate-y-0.5 hover:border-paper-700">
    <div class="flex items-start gap-4 rounded-2xl bg-paper-100/70 p-3">
      <div class="h-20 w-20 shrink-0 rounded-2xl border border-paper-700/60 bg-[#2a1a14] p-2">
        <div class="h-full rounded-xl border border-amber-500/60 p-2">
          ...
          <div class="mt-2 flex gap-2"><span class="h-2 w-2 rounded-full border border-amber-400" /><span class="h-2 w-2 rounded-full border border-amber-400" /></div>
        </div>
      </div>
    ...
    <div class="mt-4 flex gap-2">
      <button class="flex-1 rounded-full bg-[#24160f] px-3 py-2 text-xl text-paper-50 transition hover:bg-[#2f1d14]" @click="emit('play', props.program.id)">收听</button>
      <button
      ...
      <button class="rounded-full border border-paper-700 px-3 py-2 text-lg text-paper-800 transition hover:bg-paper-200" @click="emit('favorite', props.program.id)">
